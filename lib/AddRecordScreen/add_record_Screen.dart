...
class _AddRecordScreenState extends State<AddRecordScreen> {
  ...
  Future<void> _addRecord(PatientRecord patientRecord, BuildContext context) async {
    if (!isConsentGiven) {
      Fluttertoast.showToast(
          msg: 'Please confirm that you have obtained patient consent.',
  ...
  Widget build(BuildContext context) {
    ...
    return BlocProvider(
      create: (context) => AddRecordCubit(),
      child: BlocConsumer<AddRecordCubit, AddRecordState>(
                    ...
                    child: ListView(
                      ...
                      children: [
                        ...
                        CheckboxListTile(
                          ...
                          title: Text(
                            "I confirm that I have obtained the patient’s consent before creating their medical record.",
